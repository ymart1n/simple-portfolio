  ...
  return (
    <div className="layout-wrapper">
      ...
      <div className="homepage-container">
        <div>
          <h1>Hi, I'm ymart1n. I am never sleepless.</h1>
          <p>
          ...
          <p>
            ...
            bullshit, it is more efficient to waste 2 weeks building a "from
            scratch" portfolio blog that has no visitor except the author.
          </p>
          <p>
            This blog is{" "}
            <a href="https://github.com/krehwell/P-Blog">open-source</a> and is
            made using Next.js. The doc teaches everything!
          </p>
        </div>
        ...
        <div className="homepage-projects">
          ...
          <div className="homepage-project-list">
            <div className="homepage-project">
              ...
              <p>
                Hacker News Clone. Ad least 95% of the features are same + the
            ...
            <div className="homepage-project">
              ...
              <p>
                Remember Bomberman in early 20's? Well, the remake is for those
                boomers who want to learn math just so they think they were ever
                good at it
              </p>
              <div className="homepage-project-btns">
                <a
            ...
            <div className="homepage-project">
              ...
              <p>
                You write your note, you save your note, you manage your note.
            ...
            <div className="homepage-project">
              ...
              <p>
                Send message, call, and mocking each other easily (now supports
                video call)
              </p>
              <div className="homepage-project-btns">
